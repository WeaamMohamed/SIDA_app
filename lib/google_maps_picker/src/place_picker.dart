...
class PlacePicker extends StatefulWidget {
  PlacePicker({
    ...
    this.hidePlaceDetailsWhenDraggingPin = false
  }) : super(key: key);

  final String apiKey = 'AIzaSyC8duRzIq6lUb6BuMVDIpV0vEMmdfHf0WQ';

  final LatLng initialPosition = LatLng(-33.8567844, 151.213108);
  final bool useCurrentLocation = true;
  final LocationAccuracy desiredLocationAccuracy = LocationAccuracy.bestForNavigation;
  ...
  final MapType initialMapType = MapType.normal;
  final bool enableMapTypeButton = false;
  ...
  final String autocompleteLanguage = 'en';
  final List<String> autocompleteTypes;
  final List<Component> autocompleteComponents;
  final bool strictbounds;
  final String region = 'eg';
  ...
  final bool selectInitialPosition = true;
  ...
  final bool forceAndroidLocationManager = true;
